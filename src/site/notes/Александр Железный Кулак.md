---
{"tags":["персонаж"],"campaign":"Школа приключенцев Безелота. Переплетенные судьбы","metadated":true,"dg-publish":true,"aliases":["Сексимондо","Александр"],"permalink":"/aleksandr-zheleznyj-kulak/","dgPassFrontmatter":true}
---
